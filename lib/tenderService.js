...
// Update a tender
export async function updateTender(id, tender) {
    const cleanData = {
        origin: tender.origin,
        destination: tender.destination,
        date: tender.date,
        weight: tender.weight,
        price: tender.price ? parseFloat(tender.price) : null,
        carrier_price: tender.carrierPrice ? parseFloat(tender.carrierPrice) : null,
